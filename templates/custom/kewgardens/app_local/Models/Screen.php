...
namespace templates\custom\kewgardens\app_local\Models;
...
class Screen extends Model {
    ...
    function getShowtimesByMovieName($date, $keywords)
    {
        $site_id = config('fxp.site_id');
        $site_country = config('fxp.site_country');
        ...
        $kwd_sql = implode(' OR m.name LIKE ', $kwds_parts);
        $kwd_sql = 'AND m.name LIKE '.$kwd_sql;
